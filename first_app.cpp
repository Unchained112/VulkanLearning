...
namespace lve
{
        ...
        glm::vec2 top)
    {
        ...
        else
        {
            ...
            glm::vec2 buttom = (left + right) * 0.5f;
            sierpinski(vertices, depth - 1, leftTop, top, rightTop);
            sierpinski(vertices, depth - 1, left, buttom, leftTop);
            sierpinski(vertices, depth - 1, buttom, right, rightTop);
        }
    }
    ...
    void FirstApp::loadGameObjects()
    {
        ...
        triangle.transform2d.scale = {2.f, 0.7f};
    ...
    void FirstApp::recreateSwapChain()
    {
        ...
        // check compatibility, if render pass compatible do nothing else
        createPipeline();
    }
